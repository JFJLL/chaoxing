    ...
    <main className="flex min-h-screen items-center justify-center bg-white px-4">
      <section className="w-full max-w-md rounded-lg bg-white p-8 shadow-panel">
        ...
        <form action="/api/auth/register" method="post" className="mt-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-slate-900 outline-none transition focus:border-yimei-sidebar focus:ring-2 focus:ring-[#F9ECE7]"
            >
        ...
        <div className="mt-6 text-center text-sm text-slate-500">
          已有账号？{" "}
          <Link href="/login" className="font-medium text-[#A8402F] hover:underline">
            直接登录
          </Link>
        </div>
      </section>

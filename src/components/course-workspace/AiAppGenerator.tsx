...
export function AiAppGenerator({
  ...
  useEffect(() => {
    ...
    if (recommendationResolvedSource.current === sourceArtifactId) {
      // Already resolved for this source; clear any stale error from a failed
      // fetch of a different source so the valid recommendation shows again.
      setRecommendationError("");
      return;
    }

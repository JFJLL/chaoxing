...
export function AiAppGenerator({
  ...
  useEffect(() => {
    // Recommend slide count only for AI courseware with a chosen source lesson
    // plan. PPT courseware never needs this because its page count is fixed by
    // the already-generated AI courseware.
    ...
    if (recommendationResolvedSource.current === sourceArtifactId) return;
    void fetchSlideRecommendation(sourceArtifactId);
  }, [app.appType, sourceArtifactId, fetchSlideRecommendation]);

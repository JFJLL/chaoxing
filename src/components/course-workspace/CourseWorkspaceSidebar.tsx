    ...
    <aside className="w-full shrink-0 border-r border-slate-100 bg-white p-4 lg:w-[248px]">
      ...
      <nav className="mt-4 space-y-1.5">
        ...
        <a
          ...
          className="flex h-11 items-center gap-3 rounded-lg px-3 text-sm font-normal text-slate-700 transition hover:bg-slate-50 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
        >

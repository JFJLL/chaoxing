...
export function AdminCenter() {
  ...
  return <div className="space-y-6">
    <header className="flex flex-col justify-between gap-4 rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50 to-white p-6 lg:flex-row lg:items-center">
      <div><div className="flex items-center gap-2 text-sm font-medium text-indigo-700"><ShieldCheck className="h-4 w-4" />最高权限控制台</div><h1 className="mt-2 text-2xl font-semibold text-slate-900">平台运营管理</h1><p className="mt-2 text-sm leading-6 text-slate-600">管理员可查看全量课程、用户、充值订单和模型供应商实际返回的 AI Token，并通过审计账本调整用户可用积分。</p></div>
